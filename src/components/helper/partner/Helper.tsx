...
export const selectData = [
  ...
  },
  {
    ...
    options: [
      { label: "Less then 1000", value: "Less then 1000" },
      { label: "1000 to 2000", value: "1000 to 2000" },
      { label: "2000 to 3000", value: "2000 to 3000" },
      { label: "3000 to 4000", value: "3000 to 4000" },
      { label: "4000 to 5000", value: "4000 to 5000" },
      { label: "5000 to 6000", value: "5000 to 6000" },
      { label: "6000 to 7000", value: "6000 to 7000" },
      { label: "7000 to 8000", value: "7000 to 8000" },
      { label: "8000 to 9000", value: "8000 to 9000" },
      { label: "9000 to 10,000", value: "9000 to 10,000" },
    ],
  },
  {
    name: "bodyType",
    labelName: "Body Type",
    placeholder: " Enter car BodyType",
    options: [
      { label: "SUV", value: "SUV" },
...
export const labelData = [
  {
    label: "Interior Color of Car",
    type: "text",
    placeholder: "Interior Color of Car",
    htmlFor: "interiorColorCar",
  },
  {
