...
function Header() {
  return (
    <div className="flex !items-center justify-center bg-[url('/assets/png/popular-destinations-heor-bg-img.png')] bg-cover bg-center py-[78px] lg:h-screen lg:py-[120px] xl:py-[218px]">
