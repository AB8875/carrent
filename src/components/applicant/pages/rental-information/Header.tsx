...
function Header() {
  return (
    <div className="bg-gray relative pt-[80px] pb-[60px] md:pt-[190px] md:pb-[165px]">
      <div className="mx-auto flex h-full max-w-[1720px] flex-col justify-between px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
        <div className="flex flex-col justify-between md:flex-row">
          <div className="relative z-10">
            <Heading
              title="Everything you Need To Know About Car & Bike Rent  "
            ...
            />
            <SubPara
              title="Your Journey Begins Here: Follow These Easy Steps to Book Your Rental Car Today"
              className="!text-light-white mt-[15px] max-w-[678px] text-center md:mt-5 md:text-start"
            />
          </div>
